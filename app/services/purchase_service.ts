...
export default class PurchaseService {
  ...
  public async processPurchase(payload: PurchasePayload) {
    ...
    try {
      ...
      return { success: false, message: 'An error occurred while processing the transaction.', error: error.message }
    }
  }
   ...
   */
  public async refundPurchase(transactionId: number): Promise<{ success: boolean, message?: string }> {
